...
- Features:
  ...
  - +48 часов Premium бесплатно при регистрации
...
- Features:
  ...
  - Генерация планов тренировок: до 10 планов в час, включая план на месяц вперёд
...
При регистрации — 48 часов Premium в подарок. Привязка карты не требуется.
