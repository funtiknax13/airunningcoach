...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin', component: () => import('@/pages/AdminToolsPage.vue'),  meta: { auth: true, admin: true } },
    { path: '/admin/analytics', component: () => import('@/pages/AdminAnalyticsPage.vue'), meta: { auth: true, admin: true } },
