...
from app.routers import auth, activities, goals, training, chat, ai_insights, payments, support, admin_support, tools, push, achievements
...
app.include_router(admin_support.router, prefix="/api")
